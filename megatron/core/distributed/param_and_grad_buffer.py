...
def group_params_for_buffers(
    ...
    for param in params:
        ...
        # UltraEP replicas live in cross-layer runtime buffers and do not participate in DDP.
        # Filter them here so precomputed distributed-optimizer layouts match DDP construction.
